...
class AuthFirebaseService implements AuthService {
  ...
  static final _userStream = Stream<ComUser?>.multi((controller) async {
  ...
  Future<void> _saveChatUser(ComUser user) async {
  ...
  static ComUser _toChatUser(User user, [String? imageURL]) {
    return ComUser(
      id: user.uid,
